...
$connection = mysqli_connect(DB_SERVER, DB_USERNAME, DB_PASSWORD);
  ...
  if (strlen($Name) || strlen($Id) || strlen($Grade) || strlen($Points) || strlen($Status) || strlen($Comments)) {
    AddTenantGrades($connection, $Name, $Id, $Points, $Grade, $Status, $Comments);
  }


 /* Add tenant to the table. */
function AddTenantGrades($connection, $Name, $Id, $Points, $Grade, $Status, $Comments) {
   ...
   $query = "INSERT INTO `Tenant_Data` (`Tenant_Name`, `TENANT_ID`, `Column_1`, `Column_2`, `Column_3`, `Column_4`, `Column_5`,`Column_6`) VALUES ('$n', $i, '$g', '$p', '$s', '$c','null', 'null')";
